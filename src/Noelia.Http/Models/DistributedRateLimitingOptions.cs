...
namespace Noelia.Infrastructure.Models;
...
public class DistributedRateLimitingOptions
{
    ...
    /// a tenant, an API key, anything the application knows and Noelia does not.
    /// </summary>
    /// <remarks>
    ...
    /// </summary>
    /// <remarks>
    /// <para>It used to arrive holding seven paths from the application Noelia
