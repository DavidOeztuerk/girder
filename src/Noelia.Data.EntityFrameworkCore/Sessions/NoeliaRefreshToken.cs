...
namespace Noelia.Data.EntityFrameworkCore.Sessions;
...
/// </para>
/// </remarks>
public sealed class NoeliaRefreshToken
{
...
public static class NoeliaRefreshTokenModelBuilderExtensions
{
    /// <summary>
    ...
    public static ModelBuilder ConfigureNoeliaRefreshTokens(
        this ModelBuilder modelBuilder,
        string tableName = "noelia_refresh_tokens")
    {
        ArgumentNullException.ThrowIfNull(modelBuilder);

        modelBuilder.Entity<NoeliaRefreshToken>(entity =>
        {
