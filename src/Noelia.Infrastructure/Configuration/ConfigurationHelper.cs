...
namespace Noelia.Infrastructure.Configuration;
...
public static class ConfigurationHelper
{
    ...
    private static string BuildPostgresConnectionString()
    {
        ...
        var database = Environment.GetEnvironmentVariable("POSTGRES_DB") ?? "noelia";
        var username = Environment.GetEnvironmentVariable("POSTGRES_USER") ?? "noelia";
