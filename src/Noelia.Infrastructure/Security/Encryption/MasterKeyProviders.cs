...
namespace Noelia.Infrastructure.Security.Encryption;
    ...
    public ConfiguredMasterKeyProvider(IConfiguration configuration)
    {
        ...
        if (string.IsNullOrWhiteSpace(configured))
        {
            throw new InvalidOperationException(
                $"{ConfigurationKey} is not set. Noelia does not generate a master key, "
...
{
    public const string DefaultSecretName = "noelia/master-key";
