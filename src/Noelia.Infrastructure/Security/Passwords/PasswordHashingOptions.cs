namespace Noelia.Infrastructure.Security.Passwords;
...
public sealed class PasswordHashingOptions
{
    ...
    /// value reports <see cref="Noelia.Abstractions.Security.Passwords.PasswordVerification.SuccessRehashNeeded"/>.
    /// </remarks>
