...
namespace Noelia.Infrastructure.Security.Headers;
...
public class SecurityHeadersMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        finally
        {
            ...
            try
            {
                var performanceMetrics = context.RequestServices.GetService<Noelia.Infrastructure.Observability.IPerformanceMetrics>();
                var normalizedEndpoint = Noelia.Infrastructure.Observability.PerformanceMiddleware.GetNormalizedPath(context.Request.Path);
            ...
            if (_options.LogToAuditSystem && analysisResult.OverallScore < _options.MinimumSecurityScore)
            {
                ...
                if (auditService != null)
                {
                    await auditService.LogSecurityEventAsync(
                        ...
                        Noelia.Abstractions.Security.Audit.SecurityEventSeverity.Medium,
                        new
                        {
