...
namespace Noelia.Infrastructure.Security.InputSanitization;
...
public class InputSanitizationMiddleware
{
        ...
        InjectionDetectionResult injectionResult)
    {
        ...
        try
        {
            var auditService = context.RequestServices.GetService<Noelia.Abstractions.Security.Audit.ISecurityAuditService>();
            if (auditService != null)
            {
                await auditService.LogSecurityEventAsync(
                    ...
                    {
                        RiskLevel.Critical => Noelia.Abstractions.Security.Audit.SecurityEventSeverity.Critical,
                        RiskLevel.High => Noelia.Abstractions.Security.Audit.SecurityEventSeverity.High,
                        RiskLevel.Medium => Noelia.Abstractions.Security.Audit.SecurityEventSeverity.Medium,
                        _ => Noelia.Abstractions.Security.Audit.SecurityEventSeverity.Low
                    },
                    new
                    {
    ...
    private async Task HandleInjectionAttempt(HttpContext context, InjectionDetectionResult injectionResult)
    {
        await WriteProblem(
            context,
            "https://noelia.dev/problems/input-validation-failed",
    ...
    private async Task HandleSanitizationError(HttpContext context, string message)
    {
        await WriteProblem(
            context,
            "https://noelia.dev/problems/input-sanitization-failed",
            message,
            details: null);
    }
