...
public static class SwaggerExtensions
{
        ...
        string serviceVersion = "v1")
    {
        services.AddSwaggerGen(c =>
        {
            ...
            {
                Title = $"Noelia {serviceName} API",
                Version = serviceVersion,
                Description = $"API for {serviceName} operations in the Noelia platform",
                Contact = new OpenApiContact
                {
                    Name = "Noelia Team",
                    Email = "api@noelia.com"
                }
            });
        ...
        string serviceVersion = "v1")
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint($"/swagger/{serviceVersion}/swagger.json", $"Noelia {serviceName} API {serviceVersion}");
            c.RoutePrefix = "api-docs";
            c.DocumentTitle = $"Noelia {serviceName} API Documentation";
