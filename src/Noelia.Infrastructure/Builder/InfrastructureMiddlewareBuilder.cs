...
/// <c>AddNoelia</c> records what was set up and what was deliberately left out;
...
/// Noelia's chain into their own composition root, minus the lines they wanted
/// gone. A copy like that goes quietly wrong the first time Noelia adds a
/// step.</para>
/// <para>With no <see cref="NoeliaComposition"/> in the container — the older
...
{
    private readonly NoeliaComposition? _composition;
        ...
        string serviceName)
    {
        ...
        _composition = app.ApplicationServices.GetService<NoeliaComposition>();
    }
    ...
    public bool Runs(NoeliaModule module) =>
