...
public class TelemetryBuilder
{
    ...
    private string _serviceName = "NoeliaService";
    ...
    public TelemetryBuilder AddMetrics(Action<MeterProviderBuilder>? configure = null)
    {
        _services.AddOpenTelemetry()
            .WithMetrics(builder =>
            {
                ...
                // which has never had a stable release. A stable Noelia must not
...
{
    public const string SourceName = "Noelia";
    public const string MeterName = "Noelia.Metrics";
}
