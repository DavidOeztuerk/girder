...
namespace Noelia.Abstractions.Security.Encryption;
...
public class EncryptionOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// The algorithms Noelia implements are AEADs: they authenticate whether
...
public class HashingOptions
{
    ...
    /// <summary>
    /// PBKDF2 iteration count. The default follows Noelias password-hashing
...
public class EncryptionResult
{
    ...
    /// <summary>
    /// Reserved, and left empty by Noelia's own implementation.
    /// </summary>
    /// <remarks>
