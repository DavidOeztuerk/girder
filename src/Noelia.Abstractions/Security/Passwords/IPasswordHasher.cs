namespace Noelia.Abstractions.Security.Passwords;
...
public static class PasswordHashing
{
    ...
    /// </remarks>
    // Stable provider key from the Noelia 4.x wire contract. Renaming it would
    // make existing password hashes unverifiable after the package rename.
    public const string PrimaryKey = "noelia.passwords.primary";
}
