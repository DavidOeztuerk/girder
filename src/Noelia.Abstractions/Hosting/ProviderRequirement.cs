...
public sealed class ProviderRequirements
{
    ...
    public void ThrowIfUnmet(IServiceProvider services)
    {
        ...
        throw new InvalidOperationException(
            $"Noelia is missing {byService.Length} provider registration(s):{Environment.NewLine}{detail}"
            + $"{Environment.NewLine}Provider packages: Noelia.Redis, Noelia.InMemory, "
            + "Noelia.Messaging.MassTransit, Noelia.Data.EntityFrameworkCore.");
    }
