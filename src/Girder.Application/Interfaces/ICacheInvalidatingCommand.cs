...
{
    /// <summary>
    /// Patterns to invalidate (e.g., "jobs:*", "job:{JobId}:*")
    /// Placeholders like {JobId} will be replaced with actual values from the command
    /// </summary>
    ...
    /// <summary>
    /// Optional: HTTP API path patterns for ETag invalidation (e.g., "/api/jobs*")
