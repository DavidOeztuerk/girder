...
namespace Noelia.Infrastructure.Tests.Security.Encryption;
...
public class ConfiguredMasterKeyProviderTests
{
    ...
    {
        // Noelia generates no master key. A key the application invents is a
...
public class SecretStoreMasterKeyProviderTests
{
    ...
    public void TheKeyComesFromTheSecretStore()
    {
        ...
        store.GetSecretAsync("noelia/master-key", Arg.Any<CancellationToken>())
    ...
    public void RegistrationDeclaresItsSecretProviderRequirement()
    {
        ...
        provider.GetRequiredService<Noelia.Abstractions.Hosting.ProviderRequirements>()
            .Unmet(provider)
