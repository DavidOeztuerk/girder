...
using Noelia.Infrastructure.Security.Passwords;

namespace Noelia.Infrastructure.Tests.Security.Passwords;
...
public class PasswordHasherTests
{
    ...
    /// and the shape other tools already speak — a system that leaves Noelia
