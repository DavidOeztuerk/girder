using Noelia.Infrastructure.Configuration;
using Noelia.Infrastructure.Models;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Options;

namespace Noelia.Infrastructure.Tests.Configuration;
...
public class ConfigurationValidatorTests
{
    ...
    public void JwtValidator_ValidConfig_NoErrors()
    {
        ...
        {
            ["JwtSettings:Secret"] = "a-valid-secret-key-that-is-at-least-32-characters-long!!",
            ["JwtSettings:Issuer"] = "NoeliaTest",
            ["JwtSettings:Audience"] = "NoeliaTestAudience",
    ...
    public void DbValidator_ValidConfig_NoErrors()
    {
        var config = BuildConfig(new Dictionary<string, string?>
        {
            ["ConnectionStrings:DefaultConnection"] = "Host=db.prod;Database=noelia;Password=SecureP@ss"
        });
        var validator = new DatabaseConfigurationValidator(config);
