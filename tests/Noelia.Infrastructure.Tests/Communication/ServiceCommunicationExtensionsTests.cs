...
using Noelia.Infrastructure.Communication.Deduplication;
using Noelia.Infrastructure.Communication.Telemetry;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Options;
using CommConfig = Noelia.Infrastructure.Communication.Configuration;
...
public class ServiceCommunicationExtensionsTests
{
    ...
    public void AddServiceCommunication_WithCachingEnabled_ShouldRegisterCache()
    {
        ...
        services.Should().Contain(d =>
            d.ServiceType == typeof(Noelia.Infrastructure.Communication.Caching.IServiceResponseCache));
    }
    ...
    public void AddServiceCommunication_WithM2MEnabled_ShouldRegisterTokenProvider()
    {
        ...
        services.Should().Contain(d =>
            d.ServiceType == typeof(Noelia.Infrastructure.Security.M2M.IServiceTokenProvider));
    }
    ...
    public void AddServiceCommunication_ShouldConfigureNamedCircuitBreakerOptions()
    {
        ...
        services.Should().Contain(d =>
            d.ServiceType == typeof(IConfigureOptions<Noelia.Infrastructure.Resilience.CircuitBreakerOptions>));
    }
    ...
    public void AddServiceCommunication_ShouldConfigureNamedRetryPolicyOptions()
    {
        ...
        services.Should().Contain(d =>
            d.ServiceType == typeof(IConfigureOptions<Noelia.Infrastructure.Resilience.RetryPolicyOptions>));
    }
    ...
    public void MapBackoffStrategy_Linear_ShouldMapToLinear()
    {
        ...
        result.Should().Be(Noelia.Infrastructure.Resilience.BackoffStrategy.Linear);
    }
    ...
    public void MapBackoffStrategy_ExponentialBackoff_ShouldMapToExponential()
    {
        ...
        result.Should().Be(Noelia.Infrastructure.Resilience.BackoffStrategy.Exponential);
    }
    ...
    public void MapBackoffStrategy_ExponentialWithJitter_ShouldMapToExponentialWithJitter()
    {
        ...
        result.Should().Be(Noelia.Infrastructure.Resilience.BackoffStrategy.ExponentialWithJitter);
    }
    ...
    private static Noelia.Infrastructure.Resilience.BackoffStrategy InvokeMapBackoffStrategy(CommConfig.BackoffStrategy strategy)
    {
        var method = typeof(ServiceCommunicationExtensions)
            .GetMethod("MapBackoffStrategy", BindingFlags.NonPublic | BindingFlags.Static);
        return (Noelia.Infrastructure.Resilience.BackoffStrategy)method!.Invoke(null, [strategy])!;
    }
