...
/// <summary>
/// Pins that <c>Noelia.Http</c> stays free of third-party packages.
/// </summary>
/// <remarks>
...
/// <c>Noelia.Infrastructure</c> pulled <strong>44</strong> transitive packages
/// and <c>Noelia.Http</c> pulled <strong>none</strong>.</para>
///
...
public class HttpPackageStaysThinTests
{
    ...
    {
        var project = ProjectFile("Noelia.Http");
        ...
        declared.Should().BeEmpty(
            "the point of Noelia.Http is that taking it costs nothing but the "
    ...
    public void The_engine_is_the_one_carrying_the_weight()
    {
        var engine = Regex.Matches(
            ProjectFile("Noelia.Infrastructure"),
