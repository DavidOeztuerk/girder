...
/// </summary>
/// <remarks>
/// The build guard covers <c>Noelia.Abstractions</c> by forbidding package
/// references outright. <c>Noelia.Infrastructure</c> needs a softer rule — it
...
public class ProviderIndependenceTests
{
    ...
    public void The_engine_carries_no_provider_beyond_the_known_ones()
    {
        ...
        found.Should().Equal(
            ...
            "a new provider in Noelia.Infrastructure binds every consumer to it, "
    ...
    public void The_engine_declares_no_provider_package_beyond_the_known_ones()
    {
        ...
        var project = FindProjectFile("Noelia.Infrastructure");
    ...
    public void The_port_package_references_no_provider()
    {
        ...
        offenders.Should().BeEmpty("Noelia.Abstractions holds ports, not implementations");
    }
    ...
    public void The_port_package_references_only_platform_abstractions()
    {
        ...
        var allowed = new[] { "System.", "Microsoft.Extensions.", "netstandard", "Noelia.Core" };
