...
public class ServiceCollectionExtensionsTests
{
    ...
    {
        var method = typeof(Noelia.Infrastructure.Extensions.ServiceCollectionExtensions)
        ...
        string serviceName)
    {
        ...
        services.Should().Contain(d =>
            d.ServiceType == typeof(Noelia.Infrastructure.Communication.IServiceCommunicationManager));
    }
        ...
        string serviceName)
    {
        ...
        services.Should().Contain(d =>
            d.ServiceType == typeof(Noelia.Infrastructure.Caching.CacheInvalidationService));
    }
