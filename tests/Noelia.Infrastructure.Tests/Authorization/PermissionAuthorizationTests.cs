...
namespace Noelia.Infrastructure.Tests.Authorization;
...
public class RequirePermissionAttributeTests
{
    ...
    public void ExactlyOneAttributeOfThisNameExists()
    {
        ...
        types[0].FullName.Should()
            .Be("Noelia.Infrastructure.Security.Authorization.RequirePermissionAttribute");
    }
...
public class PermissionAuthorizationExtensionsTests
{
    ...
    [Fact]
    public async Task AddNoeliaAuthorization_ThenPermissionAuthorization_ResolvesAnAttributePolicy()
    {
        ...
        var services = new ServiceCollection();
        services.AddLogging();
        services.AddNoeliaAuthorization();
        services.AddPermissionAuthorization();
