...
namespace Noelia.Infrastructure.Tests.Observability;
...
{
    [Fact]
    public void TelemetryConstants_SourceName_ShouldBeNoelia()
    {
        TelemetryConstants.SourceName.Should().Be("Noelia");
    }

    [Fact]
    public void TelemetryConstants_MeterName_ShouldBeNoeliaMetrics()
    {
        TelemetryConstants.MeterName.Should().Be("Noelia.Metrics");
    }
