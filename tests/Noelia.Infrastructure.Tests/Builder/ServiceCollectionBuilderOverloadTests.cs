...
public class ServiceCollectionBuilderOverloadTests
{
    ...
    [Fact]
    public void UseNoelia_BuilderOverload_InvokesCallback()
    {
        var app = Substitute.For<IApplicationBuilder>();
        var callbackInvoked = false;

        app.UseNoelia(_environment, "TestService", mw =>
        {
            callbackInvoked = true;
    ...
    [Fact]
    public void UseNoelia_BuilderOverload_ReturnsSameAppBuilder()
    {
        var app = Substitute.For<IApplicationBuilder>();

        var result = app.UseNoelia(_environment, "TestService", _ => { });
