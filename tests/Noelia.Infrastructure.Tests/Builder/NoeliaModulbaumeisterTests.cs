...
/// </summary>
[Trait("Category", "Unit")]
public class NoeliaModulbaumeisterTests
{
    [Fact]
    public void UseRateLimiting_nimmt_das_Modul_mit_auf()
    {
        var zusammensetzung = Zusammensetzen(noelia => noelia.UseRateLimiting(rate => rate.PerOrigin()));
    ...
    {
        var options = Optionen(noelia => noelia.UseDefaults().UseRateLimiting(rate => rate.PerOrigin()));
    ...
    {
        var options = Optionen(noelia => noelia
            .UseDefaults()
    ...
    {
        var widerspruch = () => Zusammensetzen(noelia => noelia
    ...
    {
        var ohne = () => Zusammensetzen(noelia => noelia.UseJwt(_ => { }));
    ...
    {
        var zwei = () => Zusammensetzen(noelia => noelia.UseJwt(jwt => jwt
    ...
    {
        var beide = () => Zusammensetzen(noelia => noelia.UseJwt(jwt => jwt
    ...
    private static DistributedRateLimitingOptions Optionen(Action<NoeliaBuilder> konfigurieren)
    {
        var services = Dienste();
