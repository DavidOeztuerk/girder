...
public class HelpUrlsTests
{
    ...
    public void GetHelpUrl_MappedCode_ReturnsNonNullUrl(string errorCode)
    {
        ...
        url.Should().StartWith("https://docs.noelia.com/errors");
    }
    ...
    {
        HelpUrls.InvalidCredentials.Should().StartWith("https://docs.noelia.com/errors/");
        HelpUrls.ResourceNotFound.Should().StartWith("https://docs.noelia.com/errors/");
        HelpUrls.InternalError.Should().StartWith("https://docs.noelia.com/errors/");
        HelpUrls.RateLimitExceeded.Should().StartWith("https://docs.noelia.com/errors/");
    }
}
